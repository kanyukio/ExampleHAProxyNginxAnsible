...
6. Масштабирование:
   ...
   Абсолютно, масштабирование является важной частью создания высокодоступной инфраструктуры. Вот как вы можете добавить дополнительные веб-серверы и настроить HAProxy для учета новых узлов:
